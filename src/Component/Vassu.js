...
<div className="container">
 <div className="row text-center">
   ...
   <div className="col-md-1">
     ...
     <h4 className="font-weight-bold dark-grey-text mt-1">Vassu </h4>
 ...
 <div className="col-md-11">
   <div className="testimonial mb-11">
     <div className="avatar mx-auto">
        ...
        <div class="row">
         ...
         <div class="row">
            ...
            <div class="col-sm-4 mb-">
               <div class="card mt-4">
                  <img class="card-img-top" src="Images/ig-4.jpg" alt=""/>
                  <div class="card-body">
